...
import TeamAbilityJobComponent from './assets/js/components/team-ability/teamAbilityJobComponent.js'
import TeamAbilitySkillComponent from './assets/js/components/team-ability/teamAbilitySkillComponent.js'
import TeamCreationBlogComponent from './assets/js/components/team-creation/teamCreationBlogComponent.js'
import TeamCreationProjectComponent from './assets/js/components/team-creation/teamCreationProjectComponent.js'
...
customElements.define('team-ability-job', TeamAbilityJobComponent)
customElements.define('team-ability-skill', TeamAbilitySkillComponent)
customElements.define('team-creation-blog', TeamCreationBlogComponent)
customElements.define('team-creation-project', TeamCreationProjectComponent)
