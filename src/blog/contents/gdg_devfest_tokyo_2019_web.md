...
[https://gdg-tokyo.connpass.com/event/137666/:embed:cite]
...
[https://tokyo.gdgjapan.org/devfest2019:embed:cite]
...
[https://devfest.withgoogle.com/:embed:cite]
...
[https://www.youtube.com/channel/UCXDc-ckqru8BgppXbCt0APw:embed:cite]
...
[https://developers.google.com/community/experts:embed:cite]
...
[https://it.srad.jp/story/19/03/17/043207/:embed:cite]
...
[https://www.youtube.com/watch?v=ZFvPLrKZywA:embed:cite]

HTMLは、まだ成熟されたものではなく、まだまだ改善の余地があるという考えから、
いくつかの改善提案の話が紹介されていました。
いくつか例の紹介をされていましたが、次のqiitaの記事がわかりやすかったです。

[https://qiita.com/yk_irsw/items/4659fa0af747ddf1dd72:embed:cite]
...
[https://www.youtube.com/watch?v=-oyeaIirVC0:embed:cite]

以下の記事にあるようなStylingの機能が提案中となっています。

[https://qiita.com/yk_irsw/items/c3834b07e34bfecef002:embed:cite]
...
[https://www.suzukikenichi.com/blog/how-to-make-your-content-shine-on-google-search/:embed:cite]
...
[https://jp.techcrunch.com/2019/11/12/2019-11-11-google-chrome-to-identify-and-label-slow-websites/:embed:cite]
...
[https://www.youtube.com/watch?v=7Rrv9qFMWNM:embed:cite]

詳しくは、下記をご参考下さい。

[https://medium.com/lazy-learning/my-summary-of-the-main-thread-is-overworked-underpaid-chrome-dev-summit-2019-cd65efdf1ce1:embed:cite]
...
[https://www.chromium.org/teams/web-capabilities-fugu:embed:cite]
...
[http://goo.gle/fugu-api-tracker:embed:cite]
...
[https://developer.mozilla.org/ja/docs/Tools/Performance/Frame_rate:embed:cite]
...
[https://developer.mozilla.org/ja/docs/Web/API/Web_Workers_API/Using_web_workers:embed:cite]
...
[https://github.com/GoogleChromeLabs/comlink:embed:cite]
...
[https://santatracker.google.com/:embed:cite]

ソースコードも公開されており、PWAとして良い参考例になります。

[https://github.com/google/santa-tracker-web:embed:cite]
...
[https://developers.google.com/web/fundamentals/app-install-banners/promoting-install-mobile:embed:cite]

ただ、既にネイティブアプリがある場合、PWAのインストール要求したくありません。
そんなときは、『既にネイティブアプリをインストールしているかどうか』判断する仕組みが既にあるそうです。(origin trials)

[https://web.dev/get-installed-related-apps/:embed:cite]
...
[https://developers-jp.googleblog.com/2019/03/trusted-web-activity.html:embed:cite]
...
[https://github.com/GoogleChromeLabs/llama-pack:embed:cite]
...
[https://github.com/WICG/webpackage:embed:cite]
...
[https://amp.dev/documentation/guides-and-tutorials/optimize-and-measure/signed-exchange/:embed:cite]

後者は、Webのアプリケーションを人まとまりにし、オフライン上で提供することができるそうです。

[https://www.youtube.com/watch?v=xAujz66la3Y:embed:cite]
...
[https://booth.pm/ja/items/1572900:embed:cite]
...
[https://docs.google.com/presentation/d/e/2PACX-1vQqaDZLnSTHZWlQ-SBljyKY_Q5_jCQYG8t5nx3-b5nYjld8q9J9haaYVUnioETVvG9padqOF9AXW9r3/pub?slide=id.p1:embed:cite]
